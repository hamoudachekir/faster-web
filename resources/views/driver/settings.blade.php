...
@section('title', 'Réglages - Conducteur Faster')
        ...
        <div class="bg-white rounded-3xl shadow-xl p-8">
            <div class="flex items-center space-x-4 mb-8">
                ...
                <div>
                    ...
                    <p class="text-gray-600">Paramètres de votre compte conducteur</p>
                </div>
            </div>
            ...
            <div class="space-y-6">
                <div class="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                    <div>
                        ...
                        <p class="text-sm text-gray-600">Recevoir les notifications de courses en temps réel</p>
                    </div>
                ...
                <div class="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                    <div>
                        ...
                        <p class="text-sm text-gray-600">Autoriser le partage de position en temps réel</p>
                    </div>
                    <label class="relative inline-flex items-center cursor-pointer">
                        <input type="checkbox" checked class="sr-only peer">
                        <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-[#2BD834]/20 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-[#2BD834]"></div>
                ...
                <div class="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                    <div>
                        <h3 class="font-semibold text-gray-900">Mode disponible automatique</h3>
                        <p class="text-sm text-gray-600">Passer en mode disponible automatiquement au démarrage</p>
                    </div>
                    <label class="relative inline-flex items-center cursor-pointer">
                        <input type="checkbox" class="sr-only peer">
                        <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-[#2BD834]/20 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-[#2BD834]"></div>
